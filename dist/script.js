...
window.addEventListener("DOMContentLoaded", function () {
  ...
  feedSlider.init();
  new _modules_player__WEBPACK_IMPORTED_MODULE_2__["default"](".play", ".overlay", ".close").init();
  new _modules_player__WEBPACK_IMPORTED_MODULE_2__["default"](".module__video-item .play", ".overlay", ".close").init();
...
function () {
  ...
  _createClass(Forms, [{
    ...
    key: "inputMask",
    value: function inputMask(selector) {
    ...
    key: "checkTextInput",
    value: function checkTextInput(select) {
    ...
    value: function sendForm() {
      ...
      this.forms.forEach(function (elem) {
        elem.addEventListener("submit", function (event) {
          ...
          statusMessage.textContent = _this.statusForm.load;
          document.body.prepend(statusMessage);
          var formData = new FormData(elem);

          _this.postForm(_this.urlForm, formData).then(function (res) {
            console.log(res);
            statusMessage.style.backgroundColor = "#2eb11ced";
            statusMessage.textContent = _this.statusForm.success;
          }).catch(function (e) {
            statusMessage.textContent = _this.statusForm.failure;
            statusMessage.style.backgroundColor = "#b11c56ed";
          }).finally(function () {
            _this.clearForm(elem);
...
/*#__PURE__*/
function () {
  function Player(trigger, modal, close) {
  ...
  _createClass(Player, [{
    ...
    value: function openModal() {
      ...
      this.triggerBtn.forEach(function (elem) {
        elem.addEventListener("click", function (e) {
          e.preventDefault();

          if (!elem.closest(".module__video-item") || elem.closest(".module__video-item").getAttribute("data-locked") === "false") {
            _this.openVideoBtn = elem;

            if (_this.modal.querySelector("iframe#frame")) {
              _this.modal.style.display = "flex";

              if (elem.getAttribute("data-url") !== _this.pathVideo) {
                _this.pathVideo = elem.getAttribute("data-url");

                try {
                  _this.player.loadVideoById({
                    videoId: _this.pathVideo
                  });
              ...
              _this.createPlayer(_this.pathVideo);
    ...
    key: "unlockedVideo",
    value: function unlockedVideo(elem) {
      try {
        var lockedVideoElements = elem.closest(".module__video").querySelectorAll("[data-locked='true']");

        if (lockedVideoElements.length > 0) {
          var iconPlay = elem.querySelector(".play__circle").cloneNode(true);
          var item = lockedVideoElements[0];
    ...
    key: "lockedVideo",
    value: function lockedVideo() {
      try {
        var lockedContent = document.querySelectorAll(".play__circle.closed");
        this.triggerBtn.forEach(function (elem) {
          elem.closest(".module__video-item").setAttribute("data-locked", "false");
        });
        lockedContent.forEach(function (elem) {
...
function (_Slider) {
  ...
  function MiniSlider(_ref) {
    ...
    var container = _ref.container,
        ...
        autoplayTime = _ref.autoplayTime;
  ...
  _createClass(MiniSlider, [{
    ...
    value: function showNextSlide() {
      ...
      var btnCount = 0;
      this.slides.forEach(function (elem) {
        elem.classList.remove(_this2.activeClass);
    ...
    value: function showPrevSlide() {
      ...
      var btnCount = 0;
      this.slides.forEach(function (elem) {
        elem.classList.remove(_this3.activeClass);
    ...
    value: function autoplayInit() {
      ...
      this.container.addEventListener("mouseenter", function () {
        clearInterval(_this4.autoplayId);
      });
      this.container.addEventListener("mouseleave", function () {
        _this4.autoplayId = setInterval(function () {
          _this4.showNextSlide();
        }, _this4.autoplayTime);
      });
    }
...
var Slider = function Slider(_ref) {
  var _ref$container = _ref.container,
      ...
      autoplayTime = _ref$autoplayTime === void 0 ? 5000 : _ref$autoplayTime;
